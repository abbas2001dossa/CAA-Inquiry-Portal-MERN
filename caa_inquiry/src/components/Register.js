...
import {MDBContainer ,MDBDropdown, MDBDropdownToggle, MDBDropdownMenu, MDBDropdownItem ,MDBCardImage, MDBCol,MDBCard,MDBCardBody, MDBRow, MDBBtn, MDBIcon, MDBInput, MDBCheckbox } from 'mdb-react-ui-kit';
...
function Register() {
  ...
  function handleRegister (){
    ...
    if ( formData.password == formData.repassword ){
      ...
      axios.post('http://127.0.0.1:8000/r', formData)
      .then((response) => {
        ...
        <MDBCardBody>
          ...
          <MDBRow>
            <MDBCol md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
              ...
              <div className="d-flex flex-row align-items-center mb-4 bg-secondary">
                <select value={formData.designation} onChange={handleDesignationChange} name="designation" className="w-100 custom-select">
                  <option value="">Select a designation...</option>
                  <option value="Director General"> Director General </option>
                  <option value="Director General Secretariat"> Director General Secretariat </option>
                </select>
              </div>
              ...
              <button className='mb-4 btn btn-primary btn-lg' size='lg' onClick={handleRegister} style={{ transform: 'scale(1)' }}>Register</button>
